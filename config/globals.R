...
# 2026 OBBBA — One Big Beautiful Bill Act (federal): ABAWD work requirements expand to age 55–64 (was 18–54); reduced state discretionary exemptions.
...
VAR_LOG_ADULT     <- "log(adult_recipients)"
VAR_LOG_CHILD     <- "log(child_recipients)"
